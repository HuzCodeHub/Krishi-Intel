"""
Django settings for LSPage project.
...
SECRET_KEY = 'django-insecure--(53!$f1=$)hbj--u0x*63j)f0l+dp%nl0hn5pa=--7rx(m2uo'
...
WSGI_APPLICATION = 'LSPage.wsgi.application'
